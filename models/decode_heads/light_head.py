...
#     data = feature.cpu().numpy().squeeze(0)
#     # print(data.shape)
#     # heatmap = data.mean(0)
#     # print(heatmap.shape)
...
#         # heatmap = heatmap/max_num
#         heatmap = 1.0 - heatmap # 也可以不写，就是蓝色红色互换的作用
#         heatmap = cv2.resize(heatmap, (601, 390)) # (224,224)指的是图像的size，需要resize到原图大小
#         heatmap = np.uint8(255 * heatmap)
#         heatmap = cv2.applyColorMap(heatmap, cv2.COLORMAP_JET)
#         cv2.imwrite('figs/gather.png', heatmap)
