_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/pascal_context_59.py',
...
pretrained = 'ckpts/L_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.1-sd_0.1--imagenet2012-steps_20k-lr_0.01-res_384.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=[None] * 24),
    decode_head=dict(num_classes=59, in_channels=[1024, 1024, 1024, 1024]),
    auxiliary_head=dict(num_classes=59, in_channels=1024),
